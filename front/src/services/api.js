...
export const getJourney = (departureLat, departureLng, arrivalLat, arrivalLng, date) =>
  api.get('http://127.0.0.1:5000/fake_journey?from=48.85,2.35&to=52.517,13.388&start=2019-11-28')
// ⬇ Dé-commenter pour avoir la vraie data
// api.get('/journey?from=48.85,2.35&to=52.517,13.388&start=2019-11-28')
